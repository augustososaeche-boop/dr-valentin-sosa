            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
              ...
              <div className="lg:col-span-5">
                <div className="sticky top-32 space-y-6">
                  <img 
                    src="https://private-us-east-1.manuscdn.com/sessionFile/F7xHduwsUNYEzxNQsvRJoB/sandbox/uSM2DnqtxlNZ7gRo3Ue49Y-img-1_1770671192000_na1fn_aGFsbHV4LXZhbGd1cy10b3Atdmlldw.png?x-oss-process=image/resize,w_1920,h_1920/format,webp/quality,q_80&Expires=1798761600&Policy=_&Key-Pair-Id=K2HSFNDJXOU9YS&Signature=FAI2coJHxQUmKAQXnw~En2jI1IXWtKQfPzo-qWmsx8FuAq3LLnrVrqo8dlzXut2-c86XG5JqCoNRutRaAM3Xn0swdNUsj24xFXj1XlyGYW-y4U99cvezf5vMduAbHVHam76LJ7y75AX5mZgdhHiHHQBXGnN~BbArZgJjFsljlCHt1eUYFX1ZRJ6yewuc~aDHizTZKNGPVDQ7pKjCxdFiO~1DpWuH3CA4SKVynUQ-7fcjprOMae994BA5oWLgDJKhn59xVS3CXnNfEm8a4YyPxrsNsQ7V6ACNjilKApsV66N4ZKDlFVY2Zjv9igVrACS87vGPBy2opZRxDlUaCM1ONg__"
                    alt="Hallux Valgus vista superior"
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground">
                            <strong>Clínica LA PEQUEÑA FAMILIA:</strong> Ruta 188 y Alberdi, Junín (B)<br />
                            TEL: 2364407800
                          </p>
                          <div className="mt-4">
